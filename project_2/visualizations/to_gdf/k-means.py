# Formats k-means output to a gdf graph file for Gephi
...
gdf.write('followers INT,type VARCHAR,color VARCHAR\n')
...
for line in inFile:
    ...
    gdf.write(',' + str(count) + ',' + type + ',' + color + '\n')
