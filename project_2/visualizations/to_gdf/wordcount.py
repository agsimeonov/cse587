# Formats wordcount output to a gdf graph file for Gephi
...
for line in inFile:
    ...
    gdf.write(',' + str(count) + ',' + heatmap(1, maxCount, count) + '\n')
